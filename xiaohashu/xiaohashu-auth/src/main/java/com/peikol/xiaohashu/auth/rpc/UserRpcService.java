package com.peikol.xiaohashu.auth.rpc;

import com.peikol.framework.common.response.Response;
import com.peikol.xiaohashu.user.api.UserFeignApi;
import com.peikol.xiaohashu.user.dto.req.FindUserByPhoneReqDTO;
import com.peikol.xiaohashu.user.dto.req.RegisterUserReqDTO;
import com.peikol.xiaohashu.user.dto.req.UpdateUserPasswordReqDTO;
