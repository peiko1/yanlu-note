package com.peikol.xiaohashu.count.biz.consumer;

import com.github.phantomthief.collection.BufferTrigger;
import com.google.common.collect.Lists;
import com.peikol.framework.common.util.JsonUtils;
import com.peikol.xiaohashu.count.biz.constant.MQConstants;
import com.peikol.xiaohashu.count.biz.constant.RedisKeyConstants;
import com.peikol.xiaohashu.count.biz.enums.LikeUnlikeNoteTypeEnum;
import com.peikol.xiaohashu.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.peikol.xiaohashu.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
...
public class CountNoteLikeConsumer implements RocketMQListener<String> {
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        // 按组汇总数据，统计出最终的计数
        // AggregationCountLikeUnlikeNoteMqDTO 为最终操作的计数
