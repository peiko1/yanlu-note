package com.peikol.xiaohashu.user.biz.runner;
...
import com.peikol.xiaohashu.user.biz.domain.dataobject.PermissionDO;
import com.peikol.xiaohashu.user.biz.domain.dataobject.RoleDO;
import com.peikol.xiaohashu.user.biz.domain.dataobject.RolePermissionDO;
import com.peikol.xiaohashu.user.biz.domain.mapper.PermissionDOMapper;
import com.peikol.xiaohashu.user.biz.domain.mapper.RoleDOMapper;
import com.peikol.xiaohashu.user.biz.domain.mapper.RolePermissionDOMapper;
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            ...
            if (CollUtil.isNotEmpty(roleDOS)) {
                ...
                roleKeyPermissionDOMap.forEach((roleId, permissions) -> {
