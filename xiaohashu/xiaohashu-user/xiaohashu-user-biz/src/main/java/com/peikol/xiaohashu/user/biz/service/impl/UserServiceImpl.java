package com.peikol.xiaohashu.user.biz.service.impl;
...
import com.peikol.framework.common.enums.DeletedEnum;
import com.peikol.framework.common.enums.StatusEnum;
...
import com.peikol.framework.common.util.ParamUtils;
import com.peikol.xiaohashu.oss.api.FileFeignApi;
import com.peikol.xiaohashu.user.biz.constant.RedisKeyConstants;
import com.peikol.xiaohashu.user.constant.RoleConstants;
import com.peikol.xiaohashu.user.biz.domain.dataobject.RoleDO;
import com.peikol.xiaohashu.user.biz.enums.ResponseCodeEnum;
import com.peikol.xiaohashu.user.biz.enums.SexEnum;
import com.peikol.xiaohashu.user.biz.model.vo.UpdateUserInfoReqVO;
import com.peikol.xiaohashu.user.biz.rpc.DistributedIdGeneratorRpcService;
import com.peikol.xiaohashu.user.biz.rpc.OssRpcService;
import com.peikol.xiaohashu.user.biz.service.UserService;
import com.peikol.xiaohashu.user.biz.domain.dataobject.UserDO;
import com.peikol.xiaohashu.user.biz.domain.dataobject.UserRoleDO;
import com.peikol.xiaohashu.user.biz.domain.mapper.RoleDOMapper;
import com.peikol.xiaohashu.user.biz.domain.mapper.UserDOMapper;
import com.peikol.xiaohashu.user.biz.domain.mapper.UserRoleDOMapper;
